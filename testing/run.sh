...
do
    ...
    do
       ...
       do
          ...
          ./ssa -m "models/examples/$model_item" -t 2 -r 2 $interval_item --method "$method_item" --out-dir "models/examples/$output_dir_item$count_pad" "$output_item" -f --seed "$seed_item" >"$cur_dir/logs/case$count_pad/stdout2.txt" 2>&1
          let count=count+1
